...
#ifndef OLAMAPDIRECTIONFRAMEWORK_SWIFT_H
#define OLAMAPDIRECTIONFRAMEWORK_SWIFT_H
...
#import <OlaMapDirectionFramework/OlaMapDirectionFramework.h>
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="OlaMapDirectionFramework",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
