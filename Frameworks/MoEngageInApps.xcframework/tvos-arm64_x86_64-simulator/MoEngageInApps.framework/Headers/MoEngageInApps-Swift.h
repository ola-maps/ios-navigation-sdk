...
@class MoEngageInAppWidgetAction;

@interface MoEngageInAppActionHandler (SWIFT_EXTENSION(MoEngageInApps))
/// Perform notification permission action.
/// \param action The action to perform.
///
- (void)performNotificationPermissionAction:(MoEngageInAppWidgetAction * _Nonnull)action;
@end
...
/// :nodoc:
///
- (void)downloadAssetsDataForURL:(NSURL * _Nonnull)url sdkInstance:(MoEngageSDKInstance * _Nonnull)sdkInstance withCompletionHandler:(void (^ _Nonnull)(BOOL, NSData * _Nullable))completionBlock;
@end


@class MoEngageWidgetBackground;
@class MoEngageWidgetBorder;

/// Common focus state style for widgets.
/// :nodoc:
SWIFT_CLASS("_TtC14MoEngageInApps36MoEngageInAppWidgetFocusedStateStyle")
@interface MoEngageInAppWidgetFocusedStateStyle : NSObject
/// Background style when widget gets focus.
@property (nonatomic, readonly, strong) MoEngageWidgetBackground * _Nullable background;
/// Border style when widget gets focus.
@property (nonatomic, readonly, strong) MoEngageWidgetBorder * _Nullable border;
/// Creates new focus state style.
/// \param payload The focus style payload.
///
/// \param sdkInstance The instance of the campaign.
///
- (nonnull instancetype)initWithPayloadDict:(NSDictionary * _Nonnull)payload andSDKInstance:(MoEngageSDKInstance * _Nonnull)sdkInstance OBJC_DESIGNATED_INITIALIZER;
/// Creates new focus state style for widget.
/// \param widgetType The type of the widget.
///
/// \param payload The focus state style payload.
///
/// \param sdkInstance The campaign SDK instance.
///
///
/// returns:
/// The focus state style for widget.
+ (MoEngageInAppWidgetFocusedStateStyle * _Nullable)createFor:(MoEngageInAppWidgetType)widgetType withPayloadDict:(NSDictionary * _Nullable)payload andSDKInstance:(MoEngageSDKInstance * _Nonnull)sdkInstance error:(NSError * _Nullable * _Nullable)error SWIFT_WARN_UNUSED_RESULT;
- (nonnull instancetype)init SWIFT_UNAVAILABLE;
+ (nonnull instancetype)new SWIFT_UNAVAILABLE_MSG("-init is unavailable");
@end

@class MoEngageWidgetFont;

/// Common focus state style for text widgets.
/// :nodoc:
SWIFT_CLASS("_TtC14MoEngageInApps41MoEngageInAppLabelWidgetFocusedStateStyle")
@interface MoEngageInAppLabelWidgetFocusedStateStyle : MoEngageInAppWidgetFocusedStateStyle
/// Text style when label widget gets focus.
@property (nonatomic, readonly, strong) MoEngageWidgetFont * _Nullable font;
/// Creates new focus state style.
/// \param payload The focus style payload.
///
/// \param sdkInstance The instance of the campaign.
...
/// Common focus state style for button widgets.
/// :nodoc:
SWIFT_CLASS("_TtC14MoEngageInApps42MoEngageInAppButtonWidgetFocusedStateStyle")
@interface MoEngageInAppButtonWidgetFocusedStateStyle : MoEngageInAppLabelWidgetFocusedStateStyle
/// Whether button should receive first focus
/// when InApp receives focus.
@property (nonatomic, readonly) BOOL isPrimaryFocusItem;
/// Creates new focus state style.
/// \param payload The focus style payload.
///
/// \param sdkInstance The instance of the campaign.
...
/// Utility class for <code>MoEngageInAppCampaignSubType</code> parsing to/from string value
/// :nodoc:
SWIFT_CLASS("_TtC14MoEngageInApps33MoEngageInAppCampaignSubTypeUtils")
@interface MoEngageInAppCampaignSubTypeUtils : NSObject
/// Get campaign sub type string value for provided enum.
/// \param campaignSubType The sub type to convert.
///
///
/// returns:
/// Campaign sub type string value.
+ (NSString * _Nonnull)getStrValueForCampaignSubType:(MoEngageInAppCampaignSubType)campaignSubType SWIFT_WARN_UNUSED_RESULT;
/// Get campaign sub type enum for string value.
/// \param campaignSubType The sub type string to parse.
///
///
/// returns:
/// Campaign sub type for provided string, by default general.
+ (MoEngageInAppCampaignSubType)getCampaignSubTypeForStrValue:(NSString * _Nullable)campaignSubType SWIFT_WARN_UNUSED_RESULT;
...
- (void)getSelfHandledInAppPostSync;
- (void)getSelfHandledInAppsPostSync;
...
- (NSDictionary<NSString *, NSString *> * _Nonnull)getQueryParamsForMultipleCampaignsInAppRequest SWIFT_WARN_UNUSED_RESULT;
/// Gets query parameters for request.
///
/// returns:
/// URL query parameters.
/// :nodoc:
- (NSDictionary<NSString *, NSString *> * _Nonnull)getQueryStringParamsForInAppSyncRequest SWIFT_WARN_UNUSED_RESULT;
...
- (void)getSelfHandledInAppsWithCompletionBlock:(void (^ _Nonnull)(MoEngageInAppSelfHandledData * _Nullable))completionBlock;
- (void)fetchMultipleCampaignsInAppRequestFor:(NSArray<MoEngageInAppCampaignMeta *> * _Nonnull)campaigns withCompletionBlock:(void (^ _Nonnull)(BOOL, NSDictionary * _Nullable))completion;
- (NSArray<NSDictionary<NSString *, id> *> * _Nonnull)createCampaignsRequestPayloadFrom:(NSArray<MoEngageInAppCampaignMeta *> * _Nonnull)campaigns SWIFT_WARN_UNUSED_RESULT;
@end


SWIFT_CLASS("_TtC14MoEngageInApps40MoEngageInAppControllerProviderInterface")
@interface MoEngageInAppControllerProviderInterface : NSObject
SWIFT_CLASS_PROPERTY(@property (nonatomic, class) BOOL popUpInAppPresent;)
+ (BOOL)popUpInAppPresent SWIFT_WARN_UNUSED_RESULT;
+ (void)setPopUpInAppPresent:(BOOL)value;
+ (void)getControllerWithAppId:(NSString * _Nullable)appId completion:(void (^ _Nonnull)(MoEngageInAppController * _Nullable))completion;
+ (MoEngageInAppController * _Nonnull)getControllerFor:(MoEngageSDKInstance * _Nonnull)sdkInstance SWIFT_WARN_UNUSED_RESULT;
+ (void)removeControllerFor:(MoEngageSDKInstance * _Nonnull)sdkInstance;
- (nonnull instancetype)init OBJC_DESIGNATED_INITIALIZER;
@end
...
/// :nodoc
/// Enum to get the eligible campaign
typedef SWIFT_ENUM(NSInteger, MoEngageInAppEligibleCriteria, open) {
/// return multiple campaigns
  MoEngageInAppEligibleCriteriaMultipleContext = 0,
/// returns one most eligible campaign
  MoEngageInAppEligibleCriteriaDefaultValidation = 1,
};
...
/// InApp Display Rules
SWIFT_CLASS("_TtC14MoEngageInApps18MoEngageInAppRules")
@interface MoEngageInAppRules : NSObject
...
@property (nonatomic, copy) NSArray<NSString *> * _Nonnull contexts;
- (nonnull instancetype)initWithScreenName:(NSString * _Nullable)screenName contexts:(NSArray<NSString *> * _Nonnull)contexts OBJC_DESIGNATED_INITIALIZER;
@property (nonatomic, readonly, copy) NSString * _Nonnull description;
- (nonnull instancetype)init SWIFT_UNAVAILABLE;
+ (nonnull instancetype)new SWIFT_UNAVAILABLE_MSG("-init is unavailable");
@end
...
SWIFT_CLASS("_TtC14MoEngageInApps28MoEngageInAppSelfHandledData")
@interface MoEngageInAppSelfHandledData : NSObject
/// Account infomation
@property (nonatomic, readonly, strong) MoEngageAccountMeta * _Nonnull accountMeta;
/// List of eligible selfhandled campaigns
@property (nonatomic, copy) NSArray<MoEngageInAppSelfHandledCampaign *> * _Nonnull campaigns;
@property (nonatomic, readonly, copy) NSString * _Nonnull description;
- (nonnull instancetype)init SWIFT_UNAVAILABLE;
+ (nonnull instancetype)new SWIFT_UNAVAILABLE_MSG("-init is unavailable");
@end
...
/// :nodoc:
SWIFT_CLASS("_TtC14MoEngageInApps27MoEngageInAppStorageHandler")
@interface MoEngageInAppStorageHandler : NSObject
...
+ (BOOL)isAppEnabledForInstance:(MoEngageSDKInstance * _Nonnull)sdkInstance SWIFT_WARN_UNUSED_RESULT;
+ (BOOL)isInAppEnabledForInstance:(MoEngageSDKInstance * _Nonnull)sdkInstance SWIFT_WARN_UNUSED_RESULT;
+ (BOOL)isInAppStatsEnabledForInstance:(MoEngageSDKInstance * _Nonnull)sdkInstance SWIFT_WARN_UNUSED_RESULT;
@end
...
@interface MoEngageInAppWidgetStyle (SWIFT_EXTENSION(MoEngageInApps))
...
/// \param completionBlock MoEngageInAppSelfHandledData
///
- (void)getSelfHandledInAppsWithCompletionBlock:(void (^ _Nonnull)(MoEngageInAppSelfHandledData * _Nonnull))completionBlock;
/// Method to get multiple  self-handled inApp Campaigns.
/// \param appId MoEngage Account Identifier.
///
/// \param completionBlock MoEngageInAppSelfHandledData
///
- (void)getSelfHandledInAppsFor:(NSString * _Nonnull)appId completionBlock:(void (^ _Nonnull)(MoEngageInAppSelfHandledData * _Nonnull))completionBlock;
