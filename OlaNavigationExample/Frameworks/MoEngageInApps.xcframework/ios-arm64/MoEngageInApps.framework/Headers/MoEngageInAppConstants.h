...
extern NSString* const MO_INAPP_PAYLOAD_KEY_BASE_RESOLUTION;
...
// RESOLUTION KEYS
extern NSString* const MO_INAPP_RESOLUTION_KEY_HEIGHT;
extern NSString* const MO_INAPP_RESOLUTION_KEY_WIDTH;
...
extern NSString* const MO_INAPP_STYLE_KEY_FOCUSED;
extern NSString* const MO_INAPP_STYLE_KEY_ALIGNMENT;
extern NSString* const MO_INAPP_STYLE_KEY_CONTENT_ALIGNMENT;

// FOCUS STATE KEYS
extern NSString* const MO_INAPP_STYLE_FOCUSED_START_FOCUS;

// WIDGET ALIGNMENT KEYS
extern NSString* const MO_INAPP_STYLE_KEY_ALIGNMENT_CENTER;
extern NSString* const MO_INAPP_STYLE_KEY_ALIGNMENT_LEFT;
extern NSString* const MO_INAPP_STYLE_KEY_ALIGNMENT_RIGHT;
extern NSString* const MO_INAPP_STYLE_KEY_ALIGNMENT_TOP;
extern NSString* const MO_INAPP_STYLE_KEY_ALIGNMENT_BOTTOM;
...
extern NSString* const MO_INAPP_POSITION_ORIGIN_CENTER;
