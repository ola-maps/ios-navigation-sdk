...
#ifndef OLAMAPDIRECTION_SWIFT_H
#define OLAMAPDIRECTION_SWIFT_H
...
#import <OlaMapDirection/OlaMapDirection.h>
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="OlaMapDirection",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
typedef SWIFT_ENUM_NAMED(NSInteger, MBCongestionLevel, "CongestionLevel", open) {
...
typedef SWIFT_ENUM_NAMED(NSInteger, MBDrivingSide, "DrivingSide", open) {
...
typedef SWIFT_ENUM_NAMED(NSUInteger, MBInstructionFormat, "InstructionFormat", open) {
...
typedef SWIFT_ENUM_NAMED(NSInteger, MBManeuverDirection, "ManeuverDirection", open) {
...
typedef SWIFT_ENUM_NAMED(NSInteger, MBManeuverType, "ManeuverType", open) {
...
/// The maneuver direction indicates the direction in which the user must turn relative to the current direction of travel. The exit index indicates the number of intersections, large or small, from the previous maneuver up to and including the intersection at which the user must turn.
  ...
  MBManeuverTypeTurnRight = 3,
  MBManeuverTypeTurnLeft = 4,
  MBManeuverTypeTurnSharpRight = 5,
  MBManeuverTypeTurnSharpLeft = 6,
  MBManeuverTypeTurnSlightRight = 7,
  MBManeuverTypeTurnSlightLeft = 8,
  MBManeuverTypeUturn = 9,
/// The step requires the user to continue after a turn.
  MBManeuverTypeContinue = 10,
...
/// The step’s name contains the road’s new name. To get the road’s old name, use the previous step’s name.
  MBManeuverTypePassNameChange = 11,
...
/// If <code>RouteOptions.includesExitRoundaboutManeuver</code> is set to <code>true</code>, this step is followed by an <code>.exitRoundabout</code> maneuver. Otherwise, this step represents the entire roundabout maneuver, from the entrance to the exit.
  MBManeuverTypeTakeRoundabout = 18,
...
/// The step’s name is the name of the road to take after exiting the roundabout. This maneuver type is called out separately because the user may perceive the roundabout as an ordinary intersection with an island in the middle. If this distinction is unimportant to you, you may treat the maneuver as either an ordinary <code>turn</code> or as a <code>takeRoundabout</code>.
  MBManeuverTypeTurnAtRoundabout = 20,
...
/// This maneuver type follows a <code>.takeRoundabout</code> maneuver. It is only used when <code>RouteOptions.includesExitRoundaboutManeuver</code> is set to true.
  MBManeuverTypeExitRoundabout = 21,
...
/// This maneuver type is only used by version 4 of the Mapbox Directions API.
  MBManeuverTypePassWaypoint = 25,
  MBManeuverTypeContinueFlyover = 26,
  MBManeuverTypeLeftFlyover = 27,
  MBManeuverTypeRightFlyover = 28,
  MBManeuverTypeSlightLeftFlyover = 29,
  MBManeuverTypeSlightRightFlyover = 30,
  MBManeuverTypeSharpRightFlyover = 31,
  MBManeuverTypeSharpLeftFlyover = 32,
};
...
typedef SWIFT_ENUM_NAMED(NSUInteger, MBMeasurementSystem, "MeasurementSystem", open) {
...
typedef SWIFT_ENUM_NAMED(NSUInteger, MBRouteShapeFormat, "RouteShapeFormat", open) {
...
typedef SWIFT_ENUM_NAMED(NSUInteger, MBRouteShapeResolution, "RouteShapeResolution", open) {
...
typedef SWIFT_ENUM_NAMED(NSInteger, MBTransportType, "TransportType", open) {
...
typedef SWIFT_ENUM_NAMED(NSInteger, MBVisualInstructionComponentType, "VisualInstructionComponentType", open) {
